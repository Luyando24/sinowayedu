...
<div class="carousel-caption-overlay text-white px-3 px-md-5 py-4" style="background: rgba(0, 0, 0, 0.4);">
  <div class="container">
    <h1 class="mb-2 text-center">{{ lang('hero_title') }}</h1>
    <h5 class="mb-4 text-center">{{ lang('hero_subtitle') }}</h5>
      ...
      <div class="row g-3 justify-content-center">
        ...
        <div class="col-12 col-md-2">
          <select name="degree_id" class="form-select" style="height: 50px; background-color: #f1f1f1;">
            <option value="">{{ lang('select_degree') }}</option>
      ...
      <div class="row g-3 justify-content-center mt-2">
        <div class="col-12 col-md-2">
          <select name="scholarship" class="form-select" style="height: 50px; background-color: #f1f1f1;">
            <option value="">{{ lang('select_scholarship') }}</option>
        ...
        <div class="col-12 col-md-2">
          <input type="text" name="program" class="form-control" placeholder="{{ lang('search_programs') }}" style="height: 50px; background-color: #f1f1f1;">
        </div>
        <div class="col-12 col-md-2">
          <select name="intake" class="form-select" style="height: 50px; background-color: #f1f1f1;">
            <option value="">{{ lang('select_intake') }}</option>
            <option value="Spring">Spring</option>
            <option value="Summer">Autumn</option>
          </select>
        </div>
        <div class="col-12 col-md-2">
          <button type="submit" class="btn btn-primary w-100" style="height: 50px; background: #2A7B7C;">{{ lang('search_button') }}</button>
        </div>
      </div>
    </form>
  </div>
