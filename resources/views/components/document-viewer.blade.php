    ...
    @if ($isPdf)
        <div class="space-y-2">
            <div class="flex justify-between items-center">
                ...
                <a href="{{ $documentUrl }}" target="_blank" class="text-primary-600 hover:underline text-sm">
                    Open in new tab
                </a>
            </div>
            
            <div class="border rounded-lg overflow-hidden">
                <iframe src="{{ $documentUrl }}" style="width: 100%; height: 500px;" frameborder="0"></iframe>
            </div>
        </div>
    @else
